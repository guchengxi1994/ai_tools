...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1080542399;
...
fn wire__crate__api__cv__load_beit_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::cv::load_beit(api_model_path);
                    })?;
                    Ok(output_ok)
                })())
            }
...
fn wire__crate__api__cv__load_efficientnet_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::cv::load_efficientnet(api_model_path);
                    })?;
                    Ok(output_ok)
                })())
            }
...
fn wire__crate__api__cv__run_classification_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let api_top_n = <Option<usize>>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, ()>((move || {
...
fn wire__crate__api__tools__train_chart_stream_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                (move || {
                    let output_ok = crate::api::tools::train_chart_stream(api_s)?;
                    Ok(output_ok)
                })(),
            )
        },
...
fn wire__crate__api__web_server__check_modal_status_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok(crate::api::web_server::check_modal_status())?;
                Ok(output_ok)
            })())
        },
    )
}
fn wire__crate__api__web_server__load_llm_model_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::web_server::load_llm_model(api_model_path);
                    })?;
                    Ok(output_ok)
                })())
            }
...
fn wire__crate__api__web_server__run_server_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::web_server::run_server(api_port);
                    })?;
                    Ok(output_ok)
                })())
            }
...
fn wire__crate__api__web_server__stop_server_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::web_server::stop_server();
                    })?;
                    Ok(output_ok)
                })())
            }
...
impl SseDecode for crate::cv::ClassificationResults {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_results = <Vec<(String, f32)>>::sse_decode(deserializer);
        let mut var_duration = <f64>::sse_decode(deserializer);
        return crate::cv::ClassificationResults {
            results: var_results,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        22 => wire__crate__api__tools__train_a_mlp_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__web_server__load_llm_model_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__web_server__run_server_impl(port, ptr, rust_vec_len, data_len),
        28 => wire__crate__api__web_server__stop_server_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        18 => wire__crate__api__llm__server_state_stream_impl(ptr, rust_vec_len, data_len),
        19 => wire__crate__api__simple__greet_impl(ptr, rust_vec_len, data_len),
        23 => wire__crate__api__tools__train_chart_stream_impl(ptr, rust_vec_len, data_len),
        24 => wire__crate__api__tools__train_message_stream_impl(ptr, rust_vec_len, data_len),
        25 => wire__crate__api__web_server__check_modal_status_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::cv::ClassificationResults {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
...
impl flutter_rust_bridge::IntoIntoDart<crate::cv::ClassificationResults>
    for crate::cv::ClassificationResults
{
...
impl SseEncode for crate::cv::ClassificationResults {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
